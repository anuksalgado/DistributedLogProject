...
@dso_cache = dso_local local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x3ddad23bc73c584f, ; from name: alpine-librdkafka
		i64 u0xe0ff92d470d8c532, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: alpine-librdkafka.so
		ptr null; void* handle
	}, ; 9
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x569b89acc7769fd2, ; from name: rdkafka
		i64 u0x9666a188874e7b14, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: librdkafka.so
		ptr null; void* handle
	}, ; 16
	%struct.DSOCacheEntry {
		i64 u0x5e2a32d0367b3e8c, ; from name: librdkafka
		i64 u0x9666a188874e7b14, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: librdkafka.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x77efe9e682ba1a6a, ; from name: centos8-librdkafka
		i64 u0xee694325b78000da, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: centos8-librdkafka.so
		ptr null; void* handle
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x9666a188874e7b14, ; from name: librdkafka.so
		i64 u0x9666a188874e7b14, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: librdkafka.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xaaee842fcde4b894, ; from name: rdkafka.so
		i64 u0x9666a188874e7b14, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: librdkafka.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe0ff92d470d8c532, ; from name: alpine-librdkafka.so
		i64 u0xe0ff92d470d8c532, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: alpine-librdkafka.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xee694325b78000da, ; from name: centos8-librdkafka.so
		i64 u0xee694325b78000da, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: centos8-librdkafka.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.dsmaui\00", align 16
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [14 x i8] c"librdkafka.so\00", align 1
@.DSOCacheEntry.11_name = private unnamed_addr constant [21 x i8] c"alpine-librdkafka.so\00", align 16
@.DSOCacheEntry.12_name = private unnamed_addr constant [22 x i8] c"centos8-librdkafka.so\00", align 16
